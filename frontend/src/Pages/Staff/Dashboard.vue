  ...
  <div class="grid2">
    ...
    <div class="card">
      <div class="card-h">
        ...
        <button class="btn btn-ghost btn-sm" @click="router.push('/staff/circulation')">Open Desk</button>
      </div>
    ...
    <div class="card">
      ...
      <template v-else>
        ...
        >
          <button class="btn btn-ghost btn-sm" @click="router.push('/staff/reservation')">
  ...
  <div class="grid3" style="margin-top:18px">
    ...
    <div class="card">
      ...
      <div class="card-b" style="display:flex;flex-direction:column;gap:8px">
        <button class="btn btn-primary btn-sm" @click="router.push('/staff/circulation')">
          <LucideIcon name="scan-line" class="ic-sm" /> Open Circulation Desk
        </button>
        <button class="btn btn-ghost btn-sm" @click="router.push('/staff/overdue')">
          <LucideIcon name="alarm-clock" class="ic-sm" /> View Overdue Items
        </button>
        <button class="btn btn-ghost btn-sm" @click="router.push('/staff/reports')">
