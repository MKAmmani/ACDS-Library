  ...
  routes: [
    // ── Staff panel ───────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { path: 'journals',    component: () => import('@/Pages/Staff/Journals.vue'),    meta: { title: 'Journals' } },
        { path: 'e-resources', component: () => import('@/Pages/Staff/EResources.vue'),  meta: { title: 'E-Resources' } },
    ...
    // ── Admin panel ───────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { path: 'journals',    component: () => import('@/Pages/Admin/Journals.vue'),    meta: { title: 'Journals' } },
        { path: 'e-resources', component: () => import('@/Pages/Admin/EResources.vue'),  meta: { title: 'E-Resources' } },
        ...
        { path: 'accounts',    component: () => import('@/Pages/Admin/StaffsView.vue'),  meta: { title: 'Manage Accounts' } },
    ...
    // ── Member portal ────────────────────────────────────────────────────
    {
      ...
      children: [
        ...
        { path: 'e-resources', component: () => import('@/Pages/User/EResources.vue'), meta: { title: 'E-Resources' } },
